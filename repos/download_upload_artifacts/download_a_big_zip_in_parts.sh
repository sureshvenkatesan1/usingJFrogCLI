...
# Define the URL
url="https://my.artifactory.com/artifactory/enovia-Testing/klamaven.zip"
...
cat part1 part2 > klamaven.zip

# Clean up the parts
rm part1 part2

echo "Download and combination complete. The file is saved as klamaven.zip"
